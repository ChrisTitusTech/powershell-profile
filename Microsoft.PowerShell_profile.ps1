...
############                       https://github.com/bradleybullock/powershell-profile.git.                         ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
function Update-Profile {
    try {
        $url = "https://raw.githubusercontent.com/bradleybullock/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
