...
```
irm "https://github.com/thomaskrol/powershell-profile/raw/main/setup.ps1" | iex
```
...
### 1) You will find a downloaded `CommitMono.zip` file in the folder you executed the script from. Follow these steps to install the patched `Commit Mono` nerd font family:

1. Extract the `CommitMono.zip` file.
